...
class PaymentViewSet(viewsets.ViewSet):
    ...
    def create_payment(self, request):
        ...
        post_body = {
            ...
            'currency': "BDT",
            'tran_id': tran_id,
            'success_url': f"https://hotel-backend-arcx.onrender.com/payment/success/{hotelId}/",
            'fail_url': "https://hotel-backend-arcx.onrender.com/payment/failed/",
            'cancel_url': "https://hotel-backend-arcx.onrender.com/payment/cancel/",
            'emi_option': 0,
            'cus_name': "arman",
...
class PaymentSuccessAPI(APIView):
    ...
    def post(self,request,hotelId):
        ...
        if booked:
            booked.is_paid = True
            booked.save()
            return redirect("https://hotel-front-website.netlify.app/user_dashboard.html")
...
class PaymentCancelAPI(APIView):
    ...
    def post(self, request):
        return redirect("https://hotel-front-website.netlify.app/user_dashboard.htmll")
